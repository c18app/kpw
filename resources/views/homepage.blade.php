...
@section('content')
    ...
    <ul>
        ...
        <li>Chcete vědět co znamenají ty tajemné zápisy jako by byly z vesmíru?</li>
        <li>Chcete naučit programovat web a zatím jste jen nevěděli odkud se do toho pustit?</li>
    </ul>
    ...
    <ul>
        ...
        <li>Řekneme si co potřebujete k vytvoření webu, a opravdu toho není potřeba moc, někdy stačí obyčejný textový editor</li>
    </ul>
    ...
    <ul>
        <li>Vemte si s sebou <strong>notebook</strong>, není to podmínka, ale pak si seminář tolik neužijete a vše budete muset zkoušet, až sami doma</li>
    ...
    <ul>
        ...
        <li>Získám kontakty na další lidi, keří s programováním začínají a můžeme se společně rozvíjet</li>
    </ul>
